						...
						<div class="row home-summary">
							...
							<div class="col-md-5ths col-xs-6 text-center border-right">
								<a href="<?php echo admin_url('estimates/list_estimates?status=5'); ?>">
									...
									<span class="bold text-warning mtop15 inline-block"><i class="fa fa-clock-o"></i> <?php echo _l('home_total_patients'); ?></span>
								</a>
							</div>
							<div class="col-md-5ths col-xs-6 text-center border-right">
								<a href="<?php echo admin_url('estimates/list_estimates?status=3'); ?>">
									...
									<span class="bold mtop15 text-danger inline-block"><i class="fa fa-times"></i> <?php echo _l('home_session_total_sales'); ?></span>
								</a>
							</div>
							<div class="col-md-5ths col-xs-6 text-center border-right">
								<a href="<?php echo admin_url('estimates/list_estimates?status=2'); ?>">
									...
									<span class="bold text-info mtop15 inline-block"><i class="fa fa-envelope-o"></i> <?php echo _l('home_leads_missed_consultation'); ?></span>
								</a>
							</div>
							<div class="col-md-5ths col-xs-6 text-center border-right">
								<a href="<?php echo admin_url('estimates/list_estimates?status=4'); ?>">
									...
									<span class="bold text-success mtop15 inline-block"><i class="fa fa-check"></i> <?php echo _l('home_forgot_update_session_1'); ?></span>
								</a>
							</div>
							<div class="col-md-5ths col-xs-6 text-center">

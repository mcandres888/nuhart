            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    <a href="#notesp" aria-controls="notes" role="tab" data-toggle="tab">
                        <?php echo _l('lead_add_edit_phone_notes'); ?>
                    </a>
                </li>
      ...
      <div role="tabpanel" class="tab-pane" id="notesp">
            <?php echo form_open(admin_url('leads/add_notep'),array('id'=>'lead-notesp')); ?>
            <button type="submit" class="btn btn-info pull-right mtop15 mbot15">
                <?php echo _l('lead_add_edit_add_note'); ?></button>
                <?php echo form_hidden('leadid',$lead->id); ?>
                <?php echo render_textarea('description'); ?>
